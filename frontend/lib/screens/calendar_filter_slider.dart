...
class _FiltersModalState extends State<FiltersModal> {
  ...
  void initState() {
    super.initState();
    if (FiltersModal.lastApplied != null) {
      final f = FiltersModal.lastApplied!;
  ...
  void _applyFilters() {
      ...
      FiltersModal.lastApplied = applied;
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          hint: Text(hint, style: TextStyle(color: Color(0xff71717B), fontWeight: FontWeight.w400, fontSize: 16),),
          value: value,
          isExpanded: true,
  ...
  Widget _sectionTitle(String text) => Text(text, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: Color(0xff27272A)));

  Widget _subTitle(String text) => Text(text, style: TextStyle(fontSize: 14, color: Color(0xff71717B), fontWeight: FontWeight.w500));
  ...
  Widget _collapsibleContainer({
    ...
    if (isExpanded) {
      // Expanded view with bordered container
      return Container(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: _quickDates.map((d) {
                        ...
                        return _chip(d, selected: sel, onTap: () => setState(() => _quickDateSelected = sel ? null : d));
                      }).toList(),
                    ),
                    ...
                    if (_audienceExpanded) ...[
                      ...
                      Wrap(
                        ...
                        children: _audienceQuick.map((c) {
                          ...
                          return _chip(c, selected: sel, onTap: () => setState(() => sel ? _audienceQuickSelected.remove(c) : _audienceQuickSelected.add(c)));
                        }).toList(),
                      ),
                      const SizedBox(height: 12),
