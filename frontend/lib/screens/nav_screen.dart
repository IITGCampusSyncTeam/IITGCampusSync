                ...
                InkWell(
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.person_outline, color: _selectedIndex == 2 ? TextColors.primaryDark : TextColors.muted),
                        SizedBox(height: 2,),
                        AnimatedDefaultTextStyle(style: TextStyle(fontSize: _selectedIndex == 2 ? 14 : 12, height: 1, fontWeight: FontWeight.w400, color: _selectedIndex == 2 ? TextColors.primaryDark : TextColors.muted), duration: Duration(milliseconds: 100), child: Text("Profile", maxLines: 1,)),
                      ],
                    ),
                  ),
                )
