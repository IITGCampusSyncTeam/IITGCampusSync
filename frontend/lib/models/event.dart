...
import 'tag_model.dart'; // Assuming you have a Tag model, but we won't create a new one
...
class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
      ...
      tag: json['tag'] ?? [], // Just pass the tag data as is, we'll handle it when displaying
